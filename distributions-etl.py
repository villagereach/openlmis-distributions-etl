...
#Note that the second condition part of the conditional, AND NOT(f.code = 'G102' AND period.startdate = '2015-10-01'), is intended for temporary use, pending feedback from the field office.
FACILITY_VISIT_SQL = """SELECT fv.id AS id
    ...
    WHERE period.startdate >= '%(selvStartDate)s' AND NOT(f.code = 'G102' AND period.startdate = '2015-10-01') """ % \
